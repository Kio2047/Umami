...
export type PostNavigationProp = StackNavigationProp<RootStackParamsList, "Feed"> | StackNavigationProp<RootStackParamsList, "UserProfile">;
...
export type UserProfileScreenProps = StackScreenProps<RootStackParamsList, 'UserProfile'>;
export type RestaurantProfileScreenProps = StackScreenProps<RootStackParamsList, 'RestaurantProfile'>;
