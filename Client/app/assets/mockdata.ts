import restaurantPhoto from "./restaurantphoto.png"
import foodPhoto1 from "./foodphoto1.png"
import foodPhoto2 from "./foodphoto2.png"
import foodPhoto3 from "./foodphoto3.png"
import profilePicture from "./profilepicture.jpg"

export const authorName = "Sajjad Irvani";
export { profilePicture }
export const restaurant = "Angelina's";
export const images = [restaurantPhoto, foodPhoto1, foodPhoto2, foodPhoto3];
export const scores = {food: 5.0, vibes: 4.0, value: 4.5};
export const title = "What an experience"
...
export const others = ["Samuel Kay"];
